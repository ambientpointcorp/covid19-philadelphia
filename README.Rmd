...
These have been collected since 3/21/2020:
...
```
* Set up cron jobs in your local machine with the cronR or taskscheduleR package: https://cran.r-project.org/web/packages/cronR/vignettes/cronR.html
```
library(cronR)
