...
readr::read_csv(
  httr::RETRY("GET","https://phl.carto.com/api/v2/sql?q=SELECT+*+FROM+covid_cases_by_zip&filename=covid_cases_by_zip&format=csv&skipfields=cartodb_id")$content, 
...
readr::read_csv(
  httr::RETRY("GET","https://phl.carto.com/api/v2/sql?q=SELECT+*+FROM+covid_cases_by_age&filename=covid_cases_by_age&format=csv&skipfields=cartodb_id")$content, 
  col_types = readr::cols(the_geom = readr::col_skip(), 
                          the_geom_webmercator = readr::col_skip(), 
                          count = readr::col_integer(), 
                          etl_timestamp = readr::col_character())) %>%
...
readr::read_csv(
  httr::RETRY("GET","https://phl.carto.com/api/v2/sql?q=SELECT+*+FROM+covid_cases_by_sex&filename=covid_cases_by_sex&format=csv&skipfields=cartodb_id")$content, 
  col_types = readr::cols(the_geom = readr::col_skip(), 
                          the_geom_webmercator = readr::col_skip(), 
                          count = readr::col_integer(), 
                          etl_timestamp = readr::col_character())) %>%
...
readr::read_csv(
  httr::RETRY("GET","https://phl.carto.com/api/v2/sql?q=SELECT+*+FROM+covid_cases_by_date&filename=covid_cases_by_date&format=csv&skipfields=cartodb_id")$content, 
  col_types = readr::cols(the_geom = readr::col_skip(), 
                          the_geom_webmercator = readr::col_skip(), 
...
readr::read_csv(
  httr::RETRY("GET","https://phl.carto.com/api/v2/sql?q=SELECT+*+FROM+covid_cases_by_outcome&filename=covid_cases_by_outcome&format=csv&skipfields=cartodb_id")$content, 
  col_types = readr::cols(the_geom = readr::col_skip(), 
                          the_geom_webmercator = readr::col_skip(), 
                          count = readr::col_integer(), 
                          etl_timestamp = readr::col_character())) %>%
...
readr::read_csv(
  httr::RETRY("GET","https://phl.carto.com/api/v2/sql?filename=covid_cases_by_race&format=csv&skipfields=cartodb_id,the_geom,the_geom_webmercator&q=SELECT+*+FROM+covid_cases_by_race")$content, 
